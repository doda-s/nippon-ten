...
@ApplicationScoped
public class PanacheAdditionalIngredientRepository implements AdditionalIngredientRepository, PanacheRepository<AdditionalIngredientEntity> {

    @Inject
    AdditionalIngredientMapper mapper;
